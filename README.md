...
> **⚠️ Final release of this model formulation.** The joint fit now
> implies a larger outbreak than any single data stream does on its own
> ([#212](https://github.com/epiforecasts/BVDOutbreakSize/issues/212)) and
> is being replaced by a simpler discrete-time renewal model, so treat the
