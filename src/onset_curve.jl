...
delay any consecutive pair reaches is
`report_day(s) - min(extent(s), extent(s-1))`, two days for the current
data. Delay zero is never observed, and the hazard there rests on partial
