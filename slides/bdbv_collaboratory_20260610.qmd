...
Counts come from INSP situation reports (DRC). Suspected cases and deaths include non-BVD, which the model accounts for.
...
- Several priors (delays, incubation, CFR, ascertainment) are imported from other outbreaks/contexts (e.g. 2012 Isiro)
