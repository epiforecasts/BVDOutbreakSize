...
@testitem "load_observations returns the documented fields" begin
    ...
    ## Confirmed-case history runs to the 6 June cut-off (post-28 May
    ...
    @test obs.confirmed_history.counts ==
        ...
        263, 282, 321, 344, 363, 381, 452, 488, 515]
    @test obs.confirmed_history.counts[end] == obs.confirmed_cases

    ## Confirmed deaths: recorded, growing 17 → 91 over 26 May-6 June.
