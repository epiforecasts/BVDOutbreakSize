...
@testitem "province truth pools a patch's member provinces" setup=[
    ...
    @test truth_at(obs, grid_date, "confirmed cases [other]",
        grid_date(17), grid_date(24)) == 10.0
    @test truth_at(obs, grid_date, "confirmed cases [ituri]",
        grid_date(17), grid_date(24)) == 25.0
end
...
@testitem "a patch with a member missing has no history" setup=[
    ...
    @test truth_at(obs, grid_date, "confirmed cases [other]",
        grid_date(17), grid_date(24)) isa Symbol
