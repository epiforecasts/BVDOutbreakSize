<!-- Streams and model versions. First and last dates are read from data/observations.toml at the worktree HEAD (as_of 22 September 2026); breaks from occupancy_break_dates and confirmed_break_dates; province isolation dates from province_isolation_history and province_bed_capacity_history; likelihood descriptions checked against src/models/ at the release analysed. All dates are 2026. -->
...
| Province compositions | Confirmed cases, deaths and analysed samples by province | Beta-binomial stick-breaking split of the national count | 6 June | cut-off | none |
| Province isolation | Patients in isolation and isolation beds by province | Stick-breaking split of the printed provincial sum | 27 May (beds 15 July) | 21 September | none |
...
| v2.2.0 | Unreleased | As above, with susceptible depletion, sum-to-zero province deviations and hand-written gradient rules | Adds the province splits of the analysed volume, isolation occupancy and beds | The version analysed here |
